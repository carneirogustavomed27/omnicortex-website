      ...
      <div className="flex flex-col gap-20 md:gap-32 pb-20">
        ...
        <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-20">
          ...
          <div className="container relative z-10 flex flex-col items-center text-center gap-8">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter bg-clip-text text-transparent bg-gradient-to-b from-white via-white to-white/50 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-100 max-w-4xl font-display">
        ...
        <section className="container">
          <div className="flex flex-col gap-4 mb-12 md:text-center md:items-center">
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight font-display">Core Research Areas</h2>
          ...
          <div className="relative rounded-3xl overflow-hidden border border-white/10 bg-card/30 backdrop-blur-sm">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-8 md:p-16 flex flex-col justify-center gap-6">
                <h2 className="text-3xl md:text-4xl font-bold font-display">Democratizing Universal Intelligence</h2>
        ...
        <section className="container text-center py-20">
          <div className="max-w-3xl mx-auto space-y-8">
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight font-display">Ready to build with OmniCortex?</h2>
